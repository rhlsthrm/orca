<<<<<<< HEAD
/**
 * Shared VM harness for the generated Pi/OMP/Prime status extension: transpiles
 * the source string and runs it against fake fetch/fs/child_process so tests can
 * drive real extension handlers.
 */
